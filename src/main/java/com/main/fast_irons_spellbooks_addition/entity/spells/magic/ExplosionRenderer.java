...
public class ExplosionRenderer extends EntityRenderer<Projectile> {
    ...
    public ExplosionRenderer(Context context, float scale) {
        super(context);
    ...
    public void render(Projectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        ...
        poseStack.scale(scale * 13, scale * 13, scale * 13);
