...
public class SmallExplosionProjectile extends AbstractMagicProjectile {
    public SmallExplosionProjectile(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public SmallExplosionProjectile(Level pLevel, LivingEntity pShooter) {
        this(FastEntityRegistry.SMALL_EXPLOSION_PROJECTILE.get(), pLevel);
