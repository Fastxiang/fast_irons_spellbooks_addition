...
public class AmmoSupplySpell extends AbstractSpell {
    private static final ResourceLocation spellId =
            FastIronsSpellbooksAddition.id("ammo_supply");
    ...
    public int getAmmo(int spellLevel, LivingEntity entity) {
        return 10 + ((spellLevel - 1) * 2);
    }
