...
public class RagingSlashSpell extends AbstractSpell {
    private static final ResourceLocation spellId =
            FastIronsSpellbooksAddition.id("raging_slash");
    ...
    public AnimationHolder getCastStartAnimation() {
        return PhysicalSpellAnimations.RAGING_SLASH;
    }
